...
public class CloudCalculatorPageNew {
    ...
    public CloudCalculatorPageNew(WebDriver driver) {
        this.driver = driver;
        PageFactory.initElements(driver, this);
    }

    public EstimateWindowPageNew completeCalculatorFormNew() {
        ...
        return new EstimateWindowPageNew(driver);
    }
}
